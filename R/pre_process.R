...
#' @param 
#' BID ID code used to distinguish photographs of the different board panels/frames from the same person and game.
#' @param 
...
#' filled[[1]] = pre_process(path=path, ID="QQQ", GID="Blank", BID=c("A","B"))
#'                    }

pre_process <- function(path, ID, GID="Blank", BID=c("A","B"), pre_processed=FALSE){
