...
#' @param 
#' game Select the games to merge. "G" for Giving. "L" for Leaving. "R" for Reducing. "GLR" for All. Etc.
#' @param 
...
calculate_payouts <- function(path=path,pattern=".jpg",start=1,stop=3,game="GLR",
                               GV=1,LV=0.5,KV=1,RV=-4){ 
